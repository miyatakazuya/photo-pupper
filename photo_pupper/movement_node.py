...
MOVEMENT_SEQUENCES = {
    ...
    GREETING_NOD: ['look_up_slow', 'look_down_slow', 'look_up_fast', 'look_down_slow', 'look_up_slow', 'look_down_fast', 'look_down_slow', 'look_up_fast', LOOK_MIDDLE],
    THINKING_MOTION: ['look_up_slow', 'pause_long', 'look_right', 'pause_long', LOOK_MIDDLE],
    SPEAKING_MOTION: ['look_up_slow', 'look_down_slow', 'look_up_slow', LOOK_MIDDLE, 'look_up_fast', 'look_down_slow', LOOK_MIDDLE, 'look_up_fast', 'look_down_slow', 'look_up_slow', 'look_down_slow', 'look_up_slow', LOOK_MIDDLE, 'look_up_fast', 'look_down_slow'],
    SUCCESS_DANCE: [
        STEP_LEFT,
        STEP_RIGHT,
        TURN_LEFT_SMALL,
